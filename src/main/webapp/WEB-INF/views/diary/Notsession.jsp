...
<div>
	...
	border: none; height: 35px; margin-left: 40px; font-weight: bold; margin-top: 5px;"></div>
</div>
<div>
	<img style="width: 150px; height: 150px;" src="${contextPath}/resources/tripMain/warning.jpg">
</div>	
</div>
